...
public class StudentView implements ActionListener, WindowListener {
    ...
    public StudentView () {
        ...
        txt1 = new JTextField();
        txt2 = new JTextField();
        txt3 = new JTextField("" + stu.getMoney());
    ...
    public void actionPerformed (ActionEvent ae) {
        try {
            stu.setID(Integer.parseInt(txt1.getText()));
            stu.setName(txt2.getText());
            if (ae.getSource().equals(bd)) {
                stu.setMoney(stu.getMoney() + 100);
                txt3.setText(String.valueOf(stu.getMoney()));
            }
    ...
    public void windowOpened(WindowEvent we) {
        if (new File ("StudentM.dat").exists()) {
            ...
            txt1.setText(stu.getID() + "");
            txt2.setText(stu.getName() + "");
            txt3.setText(stu.getMoney() + "");
            }
            catch (Exception e) {
                System.out.println(e);
            }
